...
use App\Http\Controllers\KepatuhanInternController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('/products', ProductController::class);
     ...
     Route::get('/manajemen_risiko/export', [ManajemenRisikoController::class, 'export'])->name('manajemen_risiko.export');
     Route::get('/manajemen_risiko/import', [ManajemenRisikoController::class, 'import'])->name('manajemen_risiko.import');
     Route::post('/manajemen_risiko/import', [ManajemenRisikoController::class, 'handleImport'])->name('manajemen_risiko.handleImport');
     Route::resource('/manajemen_risiko', ManajemenRisikoController::class);

    // Route Zona Integritas
    Route::get('/zona/export', [ZonaController::class, 'export'])->name('zona.export');
    Route::get('/zona/import', [ZonaController::class, 'import'])->name('zona.import');
    Route::post('/zona/import', [ZonaController::class, 'handleImport'])->name('zona.handleImport');
    Route::resource('/zona', ZonaController::class);

    // Route Kepatuhan Intern
    Route::get('/kepatuhan_intern/export', [KepatuhanInternController::class, 'export'])->name('kepatuhan_intern.export');
    Route::get('/kepatuhan_intern/import', [KepatuhanInternController::class, 'import'])->name('kepatuhan_intern.import');
    Route::post('/kepatuhan_intern/import', [KepatuhanInternController::class, 'handleImport'])->name('kepatuhan_intern.handleImport');
    Route::resource('/kepatuhan_intern', KepatuhanInternController::class);

    // Route Lain - Lain
    Route::get('/lain_lain/export', [LainLainController::class, 'export'])->name('lain_lain.export');
    Route::get('/lain_lain/import', [LainLainController::class, 'import'])->name('lain_lain.import');
    Route::post('/lain_lain/import', [LainLainController::class, 'handleImport'])->name('lain_lain.handleImport');
    Route::resource('/lain_lain', LainLainController::class);
