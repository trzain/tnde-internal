...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = Product::with(['category', 'unit', 'customer'])
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            // 'user_image' => 'image|file|max:2048',
        ...
        return Redirect::route('products.index')->with('success', 'Kegiatan has been created!');
    }
        ...
        try{
            ...
            foreach ( $row_range as $row ) {
                $data[] = [
                    ...
                    'customer_id' => $sheet->getCell( 'D' . $row )->getValue(),
